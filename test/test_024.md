...
## Tokens
```tsv
test/test_024.in:1:1:	ident	"print"	false	0	0.000000	(1, 1) -> (1, 6)
test/test_024.in:1:6:	lparen	"("	false	0	0.000000	(1, 6) -> (1, 7)
test/test_024.in:1:7:	integer	"1"	false	1	0.000000	(1, 7) -> (1, 8)
...
test/test_024.in:2:7:	slash	"/"	false	0	0.000000	(2, 7) -> (2, 8)
test/test_024.in:2:8:	integer	"2"	false	2	0.000000	(2, 8) -> (2, 9)
test/test_024.in:2:9:	ne	"#"	false	0	0.000000	(2, 9) -> (2, 10)
test/test_024.in:2:10:	integer	"6"	false	6	0.000000	(2, 10) -> (2, 11)
test/test_024.in:2:11:	slash	"/"	false	0	0.000000	(2, 11) -> (2, 12)
test/test_024.in:2:12:	integer	"4"	false	4	0.000000	(2, 12) -> (2, 13)
test/test_024.in:2:13:	rparen	")"	false	0	0.000000	(2, 13) -> (2, 14)
test/test_024.in:4:0:	eof	""	false	0	0.000000	(4, 0) -> (4, 0)
```
## AST
```scheme
(module
